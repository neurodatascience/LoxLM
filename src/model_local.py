...
few_shot_prompt = FewShotChatMessagePromptTemplate(
        ...
        input_variables = ['series_description','protocol_name','repetition_time','echo_time','inversion_time','pulse_sequence_type','flip_angle', 'manufacturer','model','suffix', 'task_name']
